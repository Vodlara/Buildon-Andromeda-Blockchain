...
function createBaseRawBlock() {
    return { height: "0", txsResults: [], beginBlockEvents: [], endBlockEvents: [] };
}
exports.RawBlock = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.height !== "0") {
    ...
    fromPartial(object) {
        ...
        const message = createBaseRawBlock();
        message.height = (_a = object.height) !== null && _a !== void 0 ? _a : "0";
        message.txsResults = ((_b = object.txsResults) === null || _b === void 0 ? void 0 : _b.map((e) => exports.ABCIResponseDeliverTx.fromPartial(e))) || [];
        message.beginBlockEvents = ((_c = object.beginBlockEvents) === null || _c === void 0 ? void 0 : _c.map((e) => exports.ABCIEvent.fromPartial(e))) || [];
        message.endBlockEvents = ((_d = object.endBlockEvents) === null || _d === void 0 ? void 0 : _d.map((e) => exports.ABCIEvent.fromPartial(e))) || [];
        return message;
    },
};
function createBaseABCIResponseDeliverTx() {
    return { code: 0, log: "", info: "", gasWanted: "0", gasUsed: "0", events: [], codespace: "" };
}
